...
import SustainExclusion from "./SustainExclusion";
...
const SustainInvest = ({setShowComponents ,setProgressResult}) => {
  ...
  return (
    <div className="row">
     ...
     {newauthopenModal&& <PrepareStrategy
