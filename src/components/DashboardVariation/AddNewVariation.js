...
import ExistingStrategyModal from "./ExistingStrategyModal";
const AddNewVariation = ({ openModal, setOpenModal }) => {
  ...
  return (
    <>
          ...
          <animated.div style={overlayAnimation}>
            <Modal.Body className="p-4">
              <div className="welcome-modal-main-wrapper add-strategy-modal-main-wrapper p-3">
                ...
                <div className="add-new-strategy-replace-btn-create-new">
                  <button className="w-full flex" onClick={()=> setexistOpen(true)}>
                  Add New Strategy to Existing
                    <img src={arrowRight} alt="..." />
                  </button>
                </div>
              </div>
      ...
      <ExistingStrategyModal openModal={existOpen}  setOpenModal={setexistOpen}/>
    </>
  );
};
